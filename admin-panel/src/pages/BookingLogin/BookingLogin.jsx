...
/**
 * Dedicated offline-booking desk login. Same auth as the other doors, branded
 * for booking staff and routing a booking_staff user straight to their focused
 * desk (/booking-desk). Other roles that happen to use this door are still
 * routed to their correct home.
 */
export default function BookingLogin() {
  ...
  useEffect(() => {
    ...
    if (role === 'booking_staff') {
      navigate('/booking-desk', { replace: true })
  ...
  return (
    <AuthShell
      ...
      subtitle="Sign in to book &amp; manage your hospital's queue"
      icon={CalendarPlus}
    >
