...
class _HospitalDetailScreenState extends State<HospitalDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayDoctors = catalog.doctorsForHospital(hospital.id);
    final locationLine = hospital.distance.isEmpty
        ? hospital.address
...
class _HRow extends StatelessWidget {
  final IconData icon;
  final String label, value;
  const _HRow({required this.icon, required this.label, required this.value});
  @override
